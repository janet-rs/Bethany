  ...
  <script type="text/javascript">
      var onloadCallback = function() {
        grecaptcha.render('html_element', {
          'sitekey' : '6Lf8VY8fAAAAAKqY_755QBsXvfJY7i38_8iTRRmo'
        });
      };
  </script>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form action="modelo/validacion.php" method="post">
									...
									<div class="form-group">
										<input type="password" name="passwordlg" id="passwordlg" tabindex="2" class="form-control" placeholder="Contraseña">
									</div><br>
                  <div class="g-recaptcha" name="g-recaptcha" data-sitekey="6Lf8VY8fAAAAAKqY_755QBsXvfJY7i38_8iTRRmo"></div>
									<br>
                  <div class="form-group">
										<div class="row text-center">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="login-submit" id="login-submit" tabindex="4" class="botonlg" value="Iniciar sesión">
											</div>
										</div>
									</div>
                ...
                <div class="form-group">
								    <div class="row text-center">
									    <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
										  <a href="recupera.php">¿Has olvidado la contraseña?</a>
									    </div>
								    </div>
							  </div>
                <div class="form-group">
